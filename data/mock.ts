...
export const RESOURCES: Resource[] = [
  { id:  1, category: "Financial Aid",       type: "Link",     title: "FAFSA Application Portal",                    description: "Complete or update your Free Application for Federal Student Aid.",                                                  url: "https://studentaid.gov",                              addedBy: "Dr. Amara Okafor",      addedDate: "2026-01-08" },
  { id:  2, category: "Financial Aid",       type: "Document", title: "Emergency Student Fund Request",              description: "Apply for one-time emergency financial assistance through the university student support office.",                    url: "https://example.kent.edu/emergency-fund.pdf",         addedBy: "James Mitchell",        addedDate: "2026-01-15" },
  { id:  3, category: "Financial Aid",       type: "Video",    title: "Understanding Your Aid Package",              description: "Video walkthrough explaining grants, loans, and work-study components of your financial aid offer.",                 url: "https://example.kent.edu/videos/aid-package",         addedBy: "Dr. Priya Patel",       addedDate: "2026-02-03" },
  { id:  4, category: "Disability Services", type: "Link",     title: "DSO Accommodation Request Portal",            description: "Submit and manage your accommodation requests through the Disability Services Office student portal.",                 url: "https://example.kent.edu/dso",                        addedBy: "Prof. Elena Rodriguez", addedDate: "2026-01-10" },
  { id:  5, category: "Disability Services", type: "Video",    title: "Booking Extended Time at the Testing Center", description: "Step-by-step guide to scheduling extended time exams and checking in at the campus testing center.",                 url: "https://example.kent.edu/videos/testing-center",      addedBy: "Prof. Elena Rodriguez", addedDate: "2026-02-18" },
  { id:  6, category: "Academic Support",    type: "Link",     title: "Tutoring Center Schedule",                    description: "Browse available tutoring sessions by subject and register for an open time slot.",                                  url: "https://example.kent.edu/tutoring",                   addedBy: "Prof. David Kim",       addedDate: "2026-01-20" },
  { id:  7, category: "Academic Support",    type: "Document", title: "Study Skills Handbook",                       description: "Comprehensive guide to effective study strategies, note-taking methods, and exam preparation tips.",                  url: "https://example.kent.edu/study-skills.pdf",           addedBy: "Sofia Hernandez",       addedDate: "2026-02-07" },
  { id:  8, category: "Academic Support",    type: "Video",    title: "Time Management for College Students",        description: "Short video series covering prioritization, scheduling, and building sustainable study habits.",                       url: "https://example.kent.edu/videos/time-mgmt",           addedBy: "Prof. David Kim",       addedDate: "2026-03-01" },
  { id:  9, category: "Health & Wellness",   type: "Link",     title: "Student Health Center Appointments",          description: "Book a medical or mental health appointment at the on-campus student health and counseling center.",                  url: "https://example.kent.edu/health",                     addedBy: "Dr. Marcus Williams",   addedDate: "2026-01-12" },
  { id: 10, category: "Health & Wellness",   type: "Video",    title: "Guided Stress Relief Techniques",             description: "10-minute video covering mindfulness, box breathing, and relaxation exercises for high-stress periods.",               url: "https://example.kent.edu/videos/stress-relief",       addedBy: "Dr. Chris Thompson",    addedDate: "2026-03-14" },
  { id: 11, category: "Campus Life",         type: "Link",     title: "Student Organizations Directory",             description: "Explore over 200 registered student clubs and organizations and find your campus community.",                        url: "https://example.kent.edu/orgs",                       addedBy: "James Mitchell",        addedDate: "2026-02-25" },
  { id: 12, category: "Campus Life",         type: "Document", title: "Campus Accessibility Map",                    description: "Printable map highlighting accessible entrances, elevators, reserved parking, and key building locations.",          url: "https://example.kent.edu/campus-map.pdf",             addedBy: "Dr. Amara Okafor",      addedDate: "2026-04-02" },
];
...
export const ACTIVITY_ITEMS: ActivityItem[] = [
  { id: 1, title: "Register for Spring 2027 Courses",     description: "Complete course registration for the upcoming Spring 2027 semester before the deadline.",                                       assignedTo: { type: "all",      count: 32 },                            dueDate: "2026-05-30", recurrence: "none",    completedCount: 11, totalCount: 32, overdueCount: 0,  status: "Active",  createdDate: "2026-04-15", subTasks: [{id:1,title:"Check registration portal for open slots",durationMin:10},{id:2,title:"Confirm prerequisites are met",durationMin:15},{id:3,title:"Email advisor with selected courses",durationMin:10}] },
  { id: 2, title: "Email Professor About Accommodation",  description: "Send a formal accommodation request email to each professor for the current semester.",                                         assignedTo: { type: "students", count: 12 },                            dueDate: "2026-05-15", recurrence: "none",    completedCount:  7, totalCount: 12, overdueCount: 5,  status: "Overdue", createdDate: "2026-05-01", subTasks: [{id:1,title:"Email academic advisor to confirm availability",durationMin:15},{id:2,title:"Bring updated course list to the appointment",durationMin:20},{id:3,title:"Complete pre-advising reflection form",durationMin:10}] },
  { id: 3, title: "Attend Advising Appointment",          description: "Schedule and attend a meeting with your academic advisor before course registration.",                                          assignedTo: { type: "students", count:  8 },                            dueDate: "2026-05-20", recurrence: "none",    completedCount:  3, totalCount:  8, overdueCount: 0,  status: "Active",  createdDate: "2026-04-20", subTasks: [{id:1,title:"Call advising office to schedule appointment",durationMin:10},{id:2,title:"Prepare three questions for the advisor",durationMin:15}] },
  { id: 4, title: "Complete Mid-Semester Check-In",       description: "Fill out the mid-semester progress check-in form to reflect on your goals and challenges.",                                    assignedTo: { type: "all",      count: 32 },                            dueDate: "2026-05-10", recurrence: "none",    completedCount: 20, totalCount: 32, overdueCount: 12, status: "Overdue", createdDate: "2026-04-28", subTasks: [{id:1,title:"Review progress on each course",durationMin:20},{id:2,title:"Write reflection on challenges this semester",durationMin:15},{id:3,title:"Identify one goal for the rest of the semester",durationMin:10}] },
  { id: 5, title: "Review and Update Academic Plan",      description: "Review your current academic plan and make adjustments aligned with next semester's goals.",                                    assignedTo: { type: "staff",    staffName: "Dr. Okafor", count: 10 },  dueDate: "2026-06-01", recurrence: "none",    completedCount:  4, totalCount: 10, overdueCount: 0,  status: "Active",  createdDate: "2026-04-10", subTasks: [{id:1,title:"Pull up current degree audit",durationMin:10},{id:2,title:"Identify courses to add or drop",durationMin:15},{id:3,title:"Schedule a meeting with advisor if needed",durationMin:10}] },
  { id: 6, title: "Practice Accommodation Script",        description: "Use the accommodation request script template to practice advocating for your needs with instructors.",                         assignedTo: { type: "students", count:  6 },                            dueDate: null,         recurrence: "weekly",  completedCount:  4, totalCount:  6, overdueCount: 0,  status: "Active",  createdDate: "2026-03-01", subTasks: [{id:1,title:"Read accommodation script aloud once",durationMin:10},{id:2,title:"Record yourself and review delivery",durationMin:15}] },
  { id: 7, title: "Submit Disability Services Renewal",   description: "Renew your Disability Services registration and update any changed accommodation needs for the semester.",                      assignedTo: { type: "students", count:  4 },                            dueDate: "2026-06-15", recurrence: "none",    completedCount:  0, totalCount:  4, overdueCount: 0,  status: "Active",  createdDate: "2026-04-05", subTasks: [{id:1,title:"Log into DSO portal and start renewal",durationMin:15},{id:2,title:"Upload supporting documentation",durationMin:10},{id:3,title:"Submit renewal and confirm receipt",durationMin:5}] },
  { id: 8, title: "Daily Check-In",                       description: "Log a brief daily check-in reflecting on your energy, focus, and overall well-being.",                                        assignedTo: { type: "students", count:  3 },                            dueDate: null,         recurrence: "daily",   completedCount:  2, totalCount:  3, overdueCount: 0,  status: "Active",  createdDate: "2026-05-01", subTasks: [{id:1,title:"Rate your energy level (1-5)",durationMin:2},{id:2,title:"Note one win and one challenge for the day",durationMin:5}] },
];
